      ...
      <footer className="bg-black text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          ...
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <ul className="text-gray-200 list-none p-0 font-thin flex flex-col text-left w-full">
              ...
              <li>
                <a
                  href="#"
                  className="inline-block py-2 px-3 text-gray-100 hover:text-white no-underline"
                >
                  Features
                </a>
              </li>
        ...
        <div className=" mt-4 pt-6 text-gray-300 border-t border-gray-800 text-center">
          {" "}
