...
import { FaHeart, FaStar, FaRegStar, FaMapMarkerAlt, FaCar } from 'react-icons/fa'
                        ...
                        <div className="flex flex-col flex-grow justify-between p-4">
                            ...
                            <div className="flex flex-col text-gray-500 mb-4 text-sm md:text-md ">
                                <div className='flex items-center gap-3'>
                                    <strong>Color: </strong>
                                    <span className={`${color === 'White' ? "bg-gray-400" : ""} border p-1`}> <FaCar color={color} size={20} /></span>
                                </div>
                                <p>{description}</p>
                            </div>
                            <div className="flex flex-col text-gray-500 mb-4 text-sm md:text-md ">
