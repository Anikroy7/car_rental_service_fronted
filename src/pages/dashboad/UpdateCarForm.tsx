                ...
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                    ...
                    <div className="-mx-3 md:flex">
                        <div className="md:w-full px-3">
                            ...
                            <input className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="application-link" type="text" placeholder="Type color name"
                                {...register("name", { required: true, maxLength: 50 })} defaultValue={singleCar.data.name} />
                    ...
                    <div className="-mx-3 md:flex mb-2">
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div>
                                <input defaultValue={singleCar.data.pricePerHour} className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="application-link" type="number" placeholder="Type price/h"  {...register("pricePerHour", { required: true, minLength: 2 })} />
                                <div className="text-red-500">
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div>
                                <input defaultValue={singleCar.data.color} className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="application-link" type="text" placeholder="valid color name or color values"    {...register("color", { required: true })} />
                                <div className="text-red-500">
